...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(header, file$5, 4, 2, 29);
    ...
    /* src/Meetups/MeetupItem.svelte generated by Svelte v3.46.4 */
    ...
    function create_fragment$3(ctx) {
    	...
    	button2 = new Button({
    			props: { type: "submit", caption: "Show Details" },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*description*/ 4) set_data_dev(t7, /*description*/ ctx[2]);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let { address } = $$props;
    	let { email } = $$props;
    	const writable_props = ['title', 'subtitle', 'description', 'img', 'address', 'email'];
    	...
    	return [title, subtitle, description, img, address, email];
    }
    ...
    class MeetupItem extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*img*/ ctx[3] === undefined && !('img' in props)) {
    			console.warn("<MeetupItem> was created without expected prop 'img'");
    		}
    ...
    /* src/Meetups/MeetupGrid.svelte generated by Svelte v3.46.4 */
    ...
    // (8:2) {#each meetups as meetup (meetup.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*meetups*/ 1) meetupitem_changes.img = /*meetup*/ ctx[1].imgUrl;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(8:2) {#each meetups as meetup (meetup.id)}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-18lt96");
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "svelte-18lt96");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label_1, "class", "svelte-18lt96");
    			add_location(label_1, file$1, 10, 2, 170);
    			attr_dev(div, "class", "form-control svelte-18lt96");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(form, "class", "svelte-olq5s2");
    			add_location(form, file, 56, 2, 1586);
    			attr_dev(main, "class", "svelte-olq5s2");
    			add_location(main, file, 55, 0, 1577);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    	...
    	let meetups = [
    		{
    			...
    			description: "In this meetup, we will have some experst that teach you how to code!",
    			imgUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Caffe_Nero_coffee_bar%2C_High_St%2C_Sutton%2C_Surrey%2C_Greater_London.JPG/800px-Caffe_Nero_coffee_bar%2C_High_St%2C_Sutton%2C_Surrey%2C_Greater_London.JPG",
    			address: "27th Nerd Road, 343 London",
    		...
    		},
    		{
    			...
    			imgUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Olympic_swimming_pool_%28Tbilisi%29.jpg/800px-Olympic_swimming_pool_%28Tbilisi%29.jpg",
    			address: "27th Nerd Road, 343 London",
    			contactEmail: "code@test.com"
    		}
    	];
